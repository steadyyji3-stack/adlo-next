...
import { AD_BUDGET_FAQS } from './faq-data';

export default function AdBudgetFAQ() {
    ...
    <section className="bg-white py-16 md:py-24">
      <div className="max-w-3xl mx-auto px-6 md:px-8">
        ...
        <div className="space-y-3">
          {AD_BUDGET_FAQS.map((faq, idx) => {
            const isOpen = open === idx;
            const panelId = `ad-budget-faq-panel-${idx}`;
            const buttonId = `ad-budget-faq-button-${idx}`;
            return (
              <div
                key={idx}
