...
export default function PostWriterIllustration() {
  return (
    <div
      className="relative w-full max-w-[340px] sm:max-w-[420px] md:max-w-[480px] mx-auto h-52 sm:h-60 md:h-72 mb-8 md:mb-12"
      role="img"
      aria-label="一週 7 天貼文初稿堆疊示意"
    >
      {/* 後卡 */}
      <div className="absolute top-4 sm:top-5 left-1/2 -translate-x-1/2 -rotate-[6deg] w-64 sm:w-80 md:w-[22rem] h-40 sm:h-48 md:h-56 bg-emerald-50 rounded-3xl shadow-sm ring-1 ring-emerald-100" />

      {/* 中卡 */}
      <div className="absolute top-2 sm:top-2.5 left-1/2 -translate-x-1/2 rotate-[3deg] w-64 sm:w-80 md:w-[22rem] h-40 sm:h-48 md:h-56 bg-white rounded-3xl shadow-md ring-1 ring-slate-200" />

      {/* 前卡（內容） */}
      <div className="absolute inset-x-0 top-0 mx-auto w-64 sm:w-80 md:w-[22rem] h-40 sm:h-48 md:h-56 bg-white rounded-3xl shadow-2xl ring-1 ring-emerald-200 p-5 sm:p-6 flex flex-col justify-between">
