...
import { CalendarDays, FileText, MessageSquareText, Newspaper, Star, TrendingUp, WandSparkles } from 'lucide-react';
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            <Button asChild className="bg-[#0F6E56] font-bold text-white hover:bg-[#0B5946]">
              <Link href="/customer/tools/site-optimizer"><WandSparkles aria-hidden />一鍵全站優化</Link>
            </Button>
