...
export const newServices: NewService[] = [
  ...
  /* ── 產品數位市調 ─────────────────────────────────────────── */
  {
    ...
    features: [
      {
        title: 'AI 模擬市調報告',
        desc: '不需要問 1,000 人問卷。透過搜尋行為數據 + AI 合成，在數天內模擬市調結果。例：「台北牙齒美白」— 陶瓷貼片 / 噴砂 / 居家冷光 / 鑽白各佔多少偏好？搜尋量即民調，比問卷更接近真實購買行為。',
      },
      {
        title: '搜尋偏好分佈分析',
        desc: '搜尋量是最誠實的市場投票。透過 Ahrefs、Keyword Planner 分析各選項的月搜尋量，呈現消費者在決策前真正在找什麼，直接反映潛在需求佔比與季節性趨勢。',
      },
      {
        title: '社群聲量 × 情緒分析',
        desc: '爬取 PTT、Dcard、Facebook 社團的真實討論，AI 分析各選項的好評率、常見顧慮、推薦理由。讓你知道消費者為什麼選 A 不選 B，而不只是選了什麼。',
      },
      {
        title: '競爭對手廣告偏好驗證',
        desc: '分析 Meta Ad Library 與 Google 廣告主投放的選項重點——競爭對手砸錢主打的，通常就是市場驗證過最有效的。交叉驗證你的模擬市調結果。',
      },
      {
        title: '在地城市需求差異分析',
        desc: '台北、台中、高雄的消費者偏好不同。同一個問題在不同城市，搜尋量分布、社群討論熱度、競爭格局差異顯著。我們幫你做城市級別的切割分析。',
      },
      {
        title: '完整市調報告輸出',
        desc: '所有分析整合成結構清晰的 PDF 報告：模擬問卷結果圖表、偏好分佈比例、競爭對手洞察、進入策略建議。可直接用於內部提案或投資人簡報。',
      },
    ],
    packages: [
      {
