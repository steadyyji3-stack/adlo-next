...
// ═══════════════════════════════ 裝潢修繕 ═══════════════════════════════
// 裝潢／裝修／安裝／維修 4 子項共用同一套 GBP 模板
const RENOVATION_GBP_TEMPLATES: PostBuilder[] = [
  // 週一 節慶 — 開週、定位、丈量檔期
  ({ name, theme, ctxFirst }) => ({
    title: '新的一週，先說一下檔期',
...
const INDUSTRY_TEMPLATES: Record<Industry, PostBuilder[]> = {
  裝潢: RENOVATION_GBP_TEMPLATES,
  裝修: RENOVATION_GBP_TEMPLATES,
  安裝: RENOVATION_GBP_TEMPLATES,
  維修: RENOVATION_GBP_TEMPLATES,
  // ═══════════════════════════════ 餐飲 ═══════════════════════════════
  餐飲: [
    // 週一 節慶 — 一週開頭、店面定位
    ({ name, theme, ctxFirst }) => ({
