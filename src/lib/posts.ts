...
export const posts: Post[] = [
  {
    ...
    title: 'lopia 一年走下神壇——成也 Threads 敗也 Threads，台灣中小店家最該學的一課',
    description: '2025 年初 lopia 用 Threads 一個月把台北高雄門市推到刷爆。到 2026 年，同樣是 Threads，網友群起爆料食安、標示、態度問題。從神到質疑只花一年。本文不黑特定品牌，是把這個案例拆給你看——演算法捧多高、跌下來就有多痛，台灣中小店家在 Threads 紅利期該保留什麼基本功。',
    ...
    content: `
<p class="lead">2025 年 1 月，lopia 在台北信義開了第一家店。Threads 上「日本超市來台灣了」「水果蔬菜便宜到讓人不敢相信」「凌晨四點排隊」這些 hook 短短兩週把它捧上熱搜。</p>

<p>2026 年 5 月，同樣是 Threads。「標示問題」「員工態度」「品質下滑」「越來越貴」這些字眼又把它拉下來。</p>

<p>從神到質疑，剛好一年。</p>

<p>這篇不是黑 lopia。是把這個案例拆給每個正在用 Threads 衝業績的台灣老闆看——<strong>演算法把你捧多高，跌下來就有多痛</strong>。</p>
...
<table>
  ...
  <tbody>
    <tr><td>2025 Q1</td><td>開幕。Threads「日系平價超市」hashtag 一個月內累積上萬則貼文。網友自發拍片、分享菜價、推薦朋友</td></tr>
    <tr><td>2025 Q2</td><td>第二、第三店陸續開。排隊潮持續</td></tr>
    <tr><td>2025 Q3–Q4</td><td>媒體大量報導。lopia 變成「日本超市」代名詞</td></tr>
    <tr><td>2026 Q1</td><td>第一批負評出現。「標示日期跟實際不符」「肉品包裝有問題」「員工態度差」。少數聲音，但有人開始錄影</td></tr>
    <tr><td>2026 Q2</td><td>負評全面 surface。同樣的 Threads 演算法，把負面內容也推上去——而且推得比正面更快（因為負面有更高 engagement）</td></tr>
  </tbody>
</table>

<p>從「日系神物」變成「網友群起爆料」，只用了一年。</p>

<h2>為什麼 Threads 特別容易讓品牌「過熱然後爆掉」</h2>

<p>三個結構性原因。</p>

<h3>① Threads 演算法獎勵的是「情緒密度」——不分正負面</h3>

<ul>
  <li>「lopia 太誇張了便宜到爆」 → 被推</li>
  <li>「lopia 標示有問題真的不要再去」 → 也被推</li>
</ul>

<p>跟 Facebook / IG 不同，Threads 更像 X：<strong>強情緒的內容會穿透同溫層</strong>。</p>

<p>意思是品牌正在被誇獎的時候，也在累積被打的彈藥。</p>

<h3>② 一夜爆紅 ≠ 一夜建立信任</h3>

<p>爆紅是別人幫你打廣告。但廣告要轉成信任，要時間。lopia 第一個月就湧入大量「為了便宜來」的客人——這群客人沒有信任，只有期待。</p>

<ul>
  <li>期待落空 → 立刻反彈</li>
  <li>信任落空 → 還會選擇相信你解釋</li>
</ul>

<p>lopia 失去的不是評價，是「<strong>用 1 年累積到值得有人捍衛你的信任資產</strong>」。</p>

<h3>③ 規模放大每一個小錯誤</h3>

<p>一個小店家標示錯誤 → 內部修一下。<br>
一個 Threads 上有 5 萬粉的店家標示錯誤 → 5 萬人看你怎麼回應。</p>

<p>lopia 開店 1 個月就達到通常品牌要 5 年才有的曝光量。<strong>所有營運基本功在 1 個月內被放大檢視</strong>——5 年慢慢練的事被壓縮到 30 天。</p>

<p>很少品牌能撐過這種壓力測試。lopia 是其中沒撐過的一個。</p>

<h2>三個給台灣中小店家的教訓</h2>

<h3>① 演算法給的紅利，不是你的資產</h3>

<p>Threads 把你推到 10 萬曝光是「<em>借</em>」給你的。借走的時候你還沒準備好基本功 → 後續每一個小錯都會被放大。</p>

<p><strong>行動：</strong>當你看到自己的 Threads 帖子單篇破萬讚，第一個動作不是慶祝，是檢查——產品品質、服務 SOP、客訴回應、員工訓練。每一個基本功補一下。</p>

<h3>② 信任資產要先於營收增長</h3>

<p>lopia 的問題不是「商品變差」——是<strong>信任建設沒有跟上營收增長</strong>。</p>

<p>中小店家的版本：</p>

<ul>
  <li>你的 Google 評論還停在 18 則 → 別期待 Threads 帶來的客人會相信你</li>
  <li>你的 Q&amp;A 還是空的 → 別期待新客人會自己找答案</li>
  <li>你的回覆率還是 30% → 別期待負評來時你來得及救</li>
</ul>

<p><strong>行動：</strong>Threads 開始幫你帶人之前，先把這 3 個 GBP 基本功補到 60 分以上——評論數 ≥ 30、Q&amp;A 至少 5 題、回覆率 ≥ 80%。</p>

<p>如果你想知道自己現在幾分，<a href="/check">adlo 的 GBP 健診</a>30 秒可以告訴你。</p>

<h3>③ 你說的話會被存檔，包括你沒做到的事</h3>

<p>lopia 早期 Threads 高調自誇「日本品質」「冷鏈管理」「最便宜」。<strong>這些話現在還在網路上</strong>。當品質有問題，網友會把舊文挖出來貼一次。</p>

<p><strong>行動：</strong>不要在 Threads 上承諾你<em>還沒做到 100% 的事</em>。寫「我們努力的方向是 X」比「我們是 Y」安全 10 倍。前者是過程，後者是承諾——承諾被打破會被永久留證據。</p>

<h2>那 Threads 還能用嗎？</h2>

<p>當然能用。Threads 仍是 2026 年台灣最有紅利的社群通路。問題不是「要不要用 Threads」，是<strong>用 Threads 的同時，你有沒有把基本功撐起來</strong>。</p>

<p>兩件事要同時做：</p>

<ol>
  <li>用 Threads 寫你的觀察、招牌故事、客人意見——拉觸及</li>
  <li>用基本功（GBP / Q&amp;A / 評論 / 回覆率）撐住信任——拉留存</li>
</ol>
...
<p>有人會說「lopia 也算誠信問題啦」。我覺得這個說法太簡化了。</p>

<p>更精準的版本是這樣：誠信對品牌不是<em>道德選項</em>，是<em>長線數學</em>。</p>

<ul>
  <li>短期：吹一點是 OK 的，沒人會去查（你拿到客人）</li>
  <li>中期：吹太多別人開始質疑（信任開始下滑）</li>
  <li>長期：客人翻舊帳的成本接近 0（Google 一搜就出來）</li>
</ul>

<p>10 年前的品牌可以靠遺忘——客人忘記你早期吹過什麼。Threads + Google 時代不行。你說過的每一句話都還在那裡。</p>

<p>所以「不吹自己沒做到的事」不是因為你是好人，是因為<strong>未來的你會被現在的你綁架</strong>。</p>

<h2>一句話總結</h2>

<p><strong>lopia 教我們的不是「不要紅」，是「紅了之後，要有撐得住的基本功」。</strong></p>

<p>下次你的 Threads 帖子破萬讚，回家做的第一件事不是慶祝。是檢查你的 Google 評論回覆率。</p>
`,
  },
  {
